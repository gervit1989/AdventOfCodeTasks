...
# часть 1
def part1_of_task(name_arg:str, fstr:str, col_count:int):
...
name_arg = 'in.txt'
str_find = '00000'
part1_of_task(name_arg, str_find, 5)
str_find = '000000'
part1_of_task(name_arg, str_find, 6)